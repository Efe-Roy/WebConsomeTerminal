...
const GitHub = () => {
  const userData = useQuery("ghData", () =>
    fetch("https://api.github.com/users/Efe-Roy").then((res) =>
      res.json()
    )
  );
  ...
  const repoData = useQuery("ghRepoData", () =>
    fetch(
      "https://api.github.com/repos/franciscogsilverio/Terminal-WebPortfolio" //https://api.github.com/users/Efe-Roy/repos
    ).then((res) => res.json())
  );
